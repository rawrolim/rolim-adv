...
CREATE TABLE `clientes` (
  ...
  `num_processo` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `cliente_tipo` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `clientes` VALUES (3605,'CARMELITA FERNANDES DA SILVA','898.253.307-91',NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1','2','2020-02-18',NULL,'P',NULL,NULL,'A',NULL),(3606,'Alex Sandro Grijó Ribeiro','-','','','','-','-','','-','-','','','2','1','2020-10-27','2020-10-26 17:16:51.000000','P','-','-','A',NULL);
