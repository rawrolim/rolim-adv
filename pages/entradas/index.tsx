  ...
  return (
    ...
    <main className={styles.main}>
      <div className='col-12 text-end mb-3'>
        <button onClick={() => router.push("/entradas/formulario")} className={'btn btn-primary col-12 col-sm-6 col-md-auto'}>
          Cadastrar Entrada
        </button>
      </div>
      <Table title={'Lista Entradas'} dataInit={entrada}
        columns={ [
          ...
          },
          {
            ...
            actions: [
              {
                handler: (arrReplaced = []) => router.push(`/entradas/formulario?id=${arrReplaced[0]}`),
                fieldParams: ['id'],
                name: 'Editar',
                icon: <MdEdit />
              }
