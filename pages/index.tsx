      ...
      <div>
        ...
        <footer className='footer'>
          ...
          <div className='footer_social_media'>
            <h1>Contatos</h1>
            <a href="#" className='footerlink'><img src="/images/instagram_icon.png" width={45} height={45} alt="Instagram_icon" />@rawlinsonrolimadvogado</a>
            <br /><br />
            <a href="#" className='footerlink'><img src="/images/whatsapp_icon.png" width={40} height={40} alt="Whatsapp_icon" />(22) 99965-3649</a>
          </div>
